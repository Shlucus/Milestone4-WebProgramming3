...
namespace ECommerce.Api.Products.Test
{
    public class ProductsServiceTest
    {
        ...
        public async Task GetProductsReturnsAllProducts()
        {
            ...
            var configuration = new MapperConfiguration(cfg => cfg.AddProfile(productProfile)); // this is the AutoMapper configuration, which is used to create a mapper.
            //A mapper is used to map objects of one type to objects of another type.
